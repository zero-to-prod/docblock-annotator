...
class TraitTest extends TestCase
{
    ...
    public function adds_a_comment_to_class(): void
    {
        ...
        $code = (new Annotator(['comment'], ['public'], [Statement::Trait_]))->process($file);
    ...
    public function adds_multiple_comments_to_class(): void
    {
        ...
        $code = (new Annotator(['comment1', 'comment2'], ['public'], [Statement::Trait_]))->process($file);
    ...
    public function ignores_duplicate_trait_comments(): void
    {
        ...
        $code = (new Annotator(['@link https://github.com/zero-to-prod/arr'], ['public'], [Statement::Trait_]))->process($file);
